...
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsflu:1, EVR=EVR, CODE=92, TRIG=14, FLUSH=TimesRelFlush, NELM=10000")
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsprev:1, EVR=EVR, CODE=92, TRIG=14, FLUSH=TimesRelPrevFlush, NELM=10000")
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsflu:2, EVR=EVR, CODE=93, TRIG=14, FLUSH=TimesRelFlush, NELM=10000")
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsflu:3, EVR=EVR, CODE=94, TRIG=14, FLUSH=TimesRelFlush, NELM=10000")
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsflu:4, EVR=EVR, CODE=95, TRIG=14, FLUSH=TimesRelFlush, NELM=10000")
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsfir:1, EVR=EVR, CODE=96, TRIG=14, FLUSH=TimesRelFirst, NELM=10000")
dbLoadRecords("db/mrmevrtsbuf.db","SYS=MDTST, D=evr:1-tsfir:2, EVR=EVR, CODE=97, TRIG=98, FLUSH=TimesRelFirst, NELM=10000")
